...
class _SellProductScreenState extends State<SellProductScreen> {
  ...
  // Store image as base64 data URIs or asset paths for web compatibility
  ...
  Future<void> _pickImages(ImageSource source) async {
    ...
    try {
      ...
      if (pickedFile != null) {
        ...
        // Prepend data URI scheme so AppImage can parse it correctly
  ...
  void _submit() async {
    ...
    if (!authProvider.isAuthenticated) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Anda harus masuk terlebih dahulu.', style: GoogleFonts.poppins()), backgroundColor: AppTheme.warningColor),
      );
      return;
    }
    ...
    final success = await Provider.of<ProductProvider>(context, listen: false).addProduct(product);

    if (success && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('🎉 Produk berhasil diiklankan!', style: GoogleFonts.poppins(fontWeight: FontWeight.w600)),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Gagal menambahkan produk. Coba lagi.', style: GoogleFonts.poppins()),
          backgroundColor: AppTheme.errorColor,
          behavior: SnackBarBehavior.floating,
        ),
      );
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Isi detail produk dengan jujur & lengkap',
                ...
                Text(
                  'Foto pertama akan menjadi foto utama (cover).',
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Contoh: iPhone 11 Pro 64GB',
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Tuliskan spesifikasi, kelengkapan, minus, lama pemakaian...',
                ...
                Consumer<ProductProvider>(
                  builder: (context, prov, _) => ElevatedButton(
                    ...
                    child: prov.isLoading
                        ...
                        : const Text('Pasang Iklan Sekarang'),
                  ),
                ),
